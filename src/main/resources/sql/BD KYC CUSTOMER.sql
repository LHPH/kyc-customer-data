...
BEGIN
    ...
    IF (OPERATION = 2 OR OPERATION = 3) AND ID_CUSTOMER = 0 THEN
    ...
    ELSIF OPERATION = 1 THEN
        ...
        IF V_FIRST_NAME <> P_FIRST_NAME THEN
        ...
        IF V_LAST_NAME <> P_LAST_NAME THEN
            V_LAST_NAME = P_LAST_NAME;
        END IF;

        IF V_SECOND_LAST_NAME <> P_SECOND_LAST_NAME THEN
        ...
        IF V_CELL_PHONE <> P_CELL_PHONE THEN
        ...
        IF V_STREET <> P_STREET THEN
            V_STREET = P_STREET;
        END IF;

        IF V_STREET_NUMBER <> P_STREET_NUMBER THEN
            V_STREET_NUMBER = P_STREET_NUMBER;
        END IF;

        IF V_NEIGHBOURHOOD <> P_NEIGHBOURHOOD THEN
            V_NEIGHBOURHOOD = P_NEIGHBOURHOOD;
        END IF;

        IF V_ID_STATE <> P_ID_STATE THEN
